...
fn alloc_error_handler(_layout: alloc::alloc::Layout) -> ! {
	dharitri_wasm_node::ext_error::signal_error(&b"allocation error"[..])
}
...
fn panic_fmt(panic_info: &core::panic::PanicInfo) -> ! {
	...
	dharitri_wasm_node::ext_error::signal_error(panic_msg.as_bytes())
}

#[cfg(all(feature = "wasm-output-mode", not(feature = "panic-message")))]
#[panic_handler]
fn panic_fmt(_: &core::panic::PanicInfo) -> ! {
	dharitri_wasm_node::ext_error::signal_error(&b"panic occurred"[..])
}
