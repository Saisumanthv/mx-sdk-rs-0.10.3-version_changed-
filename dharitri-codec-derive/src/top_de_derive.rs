	...
	let gen = match &ast.data {
		...
		syn::Data::Enum(data_enum) => {
			...
			if is_fieldless_enum(&data_enum) {
				...
				quote! {
					impl #impl_generics dharitri_codec::TopDecode for #name #ty_generics #where_clause {
						fn top_decode<I: dharitri_codec::TopDecodeInput>(input: I) -> core::result::Result<Self, dharitri_codec::DecodeError> {
							match <u8 as dharitri_codec::TopDecode>::top_decode(input)? {
								#(#top_decode_arms)*
						...
						fn top_decode_or_exit<I: dharitri_codec::TopDecodeInput, ExitCtx: Clone>(
							...
							match <u8 as dharitri_codec::TopDecode>::top_decode_or_exit(input, c.clone(), exit) {
