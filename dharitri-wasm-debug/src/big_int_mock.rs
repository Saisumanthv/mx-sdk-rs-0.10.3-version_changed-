...
impl dharitri_wasm::BigIntApi<RustBigUint> for RustBigInt {
	fn abs_uint(&self) -> RustBigUint {
		RustBigUint(self.0.abs())
	}

	fn sign(&self) -> dharitri_wasm::Sign {
		match self.0.sign() {
			num_bigint::Sign::Minus => dharitri_wasm::Sign::NoSign,
			num_bigint::Sign::NoSign => dharitri_wasm::Sign::NoSign,
			num_bigint::Sign::Plus => dharitri_wasm::Sign::Plus,
		}
	}
