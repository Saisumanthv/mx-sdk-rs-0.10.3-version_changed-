...
#[cfg(feature = "dharitri-wasm-module-users-default")]
use dharitri_wasm_module_users_default::*;
#[cfg(feature = "dharitri-wasm-module-users-wasm")]
use dharitri_wasm_module_users_wasm::*;
